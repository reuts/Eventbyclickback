...
export interface ApiCampaignCampaign extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isAdd: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    abstract_bg: Schema.Attribute.String;
    additional_file: Schema.Attribute.Media<'files'>;
    avatar_on_register: Schema.Attribute.Boolean &
    ...
    disable_user_creation: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    display_last_name: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    embed_id: Schema.Attribute.String;
    embed_id2: Schema.Attribute.String;
    embed_type: Schema.Attribute.Enumeration<
      ['one', 'youtube', 'facebook', 'vimeo']
    >;
    embed_type2: Schema.Attribute.Enumeration<
      ['one', 'youtube', 'facebook', 'vimeo']
    >;
    end_time: Schema.Attribute.Time;
    event_date: Schema.Attribute.DateTime;
    event_date_i18: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    event_end_date: Schema.Attribute.DateTime;
    event_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::event-type.event-type'
    >;
    extra_desc_bg: Schema.Attribute.String;
    extra_description: Schema.Attribute.RichText;
    facebook_pixel_id: Schema.Attribute.String;
    field_newsletter: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    field_phone: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    field_profession: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    file_description: Schema.Attribute.Text;
    ...
    has_tickets_page: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    hash: Schema.Attribute.UID<'name'>;
    image: Schema.Attribute.Media<'images'>;
    image_seo: Schema.Attribute.Media<'images'>;
    image2: Schema.Attribute.Media<'images'>;
    is_event_type: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    speaker_tickets_page: Schema.Attribute.Component<'content.speaker', false>;
    special_msg: Schema.Attribute.Text;
    ...
    time_text: Schema.Attribute.String;
    type_of_registration: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    upper_strip: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    visual_embeds: Schema.Attribute.Component<'embeds.visual-embed', true>;
  };
}
